    ...
    public void setAxisCommand(String cmd, String value) {
        ...
        switch (cmd) {
            case "am": {
                ...
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Axis Mode to: " + _axisMode);
                return;
            }
            case "vm": {
                int val = (int) Double.parseDouble(value);
                this.setVelocityMaximum(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Velocity Max to: " + this.getVelocityMaximum());
                return;
            }
            case "fr": {
                int val = (int) Double.parseDouble(value);
                this.setFeed_rate_maximum(val);
                Logging.print("\t[+]Set Axis: " + this.getFeed_rate_maximum() + " Feed Rate Max to: " + this.getFeed_rate_maximum());
                return;
            }
            case "tm": {
                int val = (int) Double.parseDouble(value);
                this.setTravel_maximum(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Travel Max to: " + this.getTravel_maximum());
                return;
            }
            case "jm": {
                int val = (int) Double.parseDouble(value);
                this.setJerkMaximum(val);
                Logging.print("\t[+]Set Axis: " + this.getJerkMaximum() + " Jerk Max to: " + this.getJerkMaximum());
                return;
            }
            case "jd": {
                int val = (int) Double.parseDouble(value);
                this.setJunctionDevation(val);
                Logging.print("\t[+]Set Axis: " + this.getJunction_devation() + " Junction Deviation Max to: " + this.getJunction_devation());
                return;
            }
            case "sx": {
                ...
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Axis Mode to: " + _switchMode);
                return;
            }
            case "sn": {
                int val = Double.valueOf(value.substring(0)).intValue();
            ...
            case "sv": {
                ...
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Search Velocity to: " + this.getSearch_velocity());
                return;
            }
            case "lv": {
                int val = (int) Double.parseDouble(value);
                this.setLatch_velocity(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Latch Velocity to: " + this.getLatch_velocity());
                return;
            }
            case "lb": {
                int val = (int) Double.parseDouble(value);
                this.setLatch_backoff(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Latch Back Off to: " + this.getLatch_backoff());
                return;
            }
            case "zb": {
                int val = (int) Double.parseDouble(value);
                this.setZero_backoff(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Zero Back Off to: " + this.getZero_backoff());
                return;
            }
            case "ra": {
                int val = (int) Double.parseDouble(value);
                this.setRadius(val);
                Logging.print("\t[+]Set Axis: " + this.getAxis_name() + " Radius to: " + this.getRadius());
                return;
            }
            default: {
                Logging.print("[!]Error... No such setting: " + value + " in Axis Settings...");
            }
        }
    }
...
//    }
    ...
    public Axis(AXIS ax, AXIS_TYPE at, AXIS_MODES am) {
        ...
        if (ax == AXIS.X) {
            ...
            Logging.print("[!]Invalide Axis Name Specified.\n");
        }
    }
...
//        }
    ...
    //This is the Logging method to parser a JSON Axis object
