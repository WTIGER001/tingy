...
public class SerialWriter implements Runnable {
   ...
   public void clearQueueBuffer() {
    ...
    private void sendUiMessage(String str) {
        ...
        Logging.postConsoleMessage(" Gcode Comment << " + gcodeComment);
    }
...
//                }
    ...
    @Override
    public void run() {
        Logging.print("[+]Serial Writer Thread Running...");
        while (RUN) {
            try {
...
//                }
                ...
                Logging.print("[!]Exception in SerialWriter Thread");
            }
        }
        Logging.print("[+]SerialWriter thread exiting...");
    }
}